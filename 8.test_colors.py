...
cv2.imwrite(fr'{Paths.execution}\Frame.jpg', coppelia.Camera.frame)
cv2.imwrite(fr'{Paths.execution}\Processed.jpg', coppelia.ArucoVision.processedFrame)
cv2.imwrite(fr'{Paths.execution}\Draw.jpg', coppelia.ArucoVision.drawFrame)
